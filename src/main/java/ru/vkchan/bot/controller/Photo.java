...
public class Photo {
    ...
    public static String uploadPhoto(GroupActor actor, String url1) throws ClientException, ApiException, IOException {
        File file=new File("C:\\Users\\Евгений\\Desktop\\VkBot\\src\\main\\resources\\kaguya.jpg");
        ...
        PhotoUploadResponse a= vk.upload().photo(url.getUploadUrl().toString(), file).execute();
